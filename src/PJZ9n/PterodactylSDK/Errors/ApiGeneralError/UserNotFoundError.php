...
namespace PJZ9n\PterodactylSDK\Errors\ApiGeneralError;

use PJZ9n\PterodactylSDK\Errors\PterodactylSDKError;
 ...
 */
class UserNotFoundError extends PterodactylSDKError
{
    
    public function __construct(PterodactylSDK $pterodactylSdk, $message = "User not found.", $code = 0, Throwable $previous = null)
    {
